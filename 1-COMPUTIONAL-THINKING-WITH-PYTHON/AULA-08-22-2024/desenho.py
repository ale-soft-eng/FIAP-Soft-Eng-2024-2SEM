...
class TestStringMethods(unittest.TestCase):
    ...
    def test05a_tabuleiro_xadrez(self):
        resultado4 = tabuleiro_xadrez(4)
        alvo4 = 'x.x.\n.x.x\nx.x.\n.x.x\n'
        self.assertEqual(mostra_listas(resultado4),alvo4)
        resultado8 = tabuleiro_xadrez(8)
        alvo8 = 'x.x.x.x.\n.x.x.x.x\nx.x.x.x.\n.x.x.x.x\nx.x.x.x.\n.x.x.x.x\nx.x.x.x.\n.x.x.x.x\n'
        self.assertEqual(mostra_listas(resultado8),alvo8)
...
''' Ignore esses try e except, eles tem a ver com 
o meu gabarito, e nao te ajudam em nada. Pode
deletar se preferir'''
try:
